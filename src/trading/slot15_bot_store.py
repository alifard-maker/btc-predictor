...
class Slot15BotSettings:
  ...
  def from_dict(cls, raw: dict[str, Any] | None) -> Slot15BotSettings:
    ...
    return cls(
      ...
      min_hold_seconds=int(raw.get("min_hold_seconds", 15)),
    ...
    with self._connect() as conn:
      conn.execute(
        ...
        INSERT INTO bot_positions (
          ...
          take_profit_order_id, mode, entry_source, opened_at, status
        ) VALUES (
          :id, :event_ticker, :market_ticker, :side, :contracts, :contracts_fp, :entry_price_cents,
          :cost_usd, :signal, :label, :entry_edge, :reference_price, :stop_order_id,
          :take_profit_order_id, :mode, :entry_source, :opened_at, :status
  ...
  def slot_interval_summary(
    ...
    *,
    ...
    return {
      ...
      "filled_enter_count_this_slot": int(row.get("filled_enter_count_this_hour") or row["enter_count"] or 0),
